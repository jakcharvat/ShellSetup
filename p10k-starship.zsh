typeset SHARED_RED_COLOUR=210
typeset VCS_PURPLE_COLOUR=177
...
#   typeset -g POWERLEVEL9K_DIR_PREFIX='%f '
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%f'
      local      clean="%${VCS_PURPLE_COLOUR}F"
      local 	 state="%${SHARED_RED_COLOUR}F"
      local   modified='%178F'
      local  untracked='%39F'
      ...
      local 	 state='%244F'	# grey foreground
    ...
    local showingGitStatus=0
    if (( VCS_STATUS_COMMITS_BEHIND 	 ||
      ...
      local showingGitStatus=1
    fi
    
    (( showingGitStatus )) && res+=" ${state}["
...
#     [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=$SHARED_RED_COLOUR
  ...
  typeset -g POWERLEVEL9K_CONTEXT_SUFFIX='%f in'
